...
class Email_Template {
	...
	public static function build( array $form, array $field_data, string $source_page = '' ): string {
		...
		$logo_url = esc_url( get_template_directory_uri() . '/assets/images/pc4s-logo.png' );
...
<body id="body" role="document">
  ...
  <div aria-hidden="true"
       style="font-size: 1px; line-height: 1px; display: none; max-width: 0; max-height: 0; opacity: 0; visibility: hidden; mso-hide: all; overflow: hidden;">
  ...
  <table role="presentation"
         ...
         width="100%"
         class="email-outer"
         style="background-color: <?php echo $c_page_bg; ?>; padding-top: 2rem; padding-bottom: 2rem; border-collapse: collapse;">
    <tr>
      <td align="center" style="padding:0;">
        ...
        <table role="presentation"
               ...
               style="background-color: <?php echo $c_white; ?>; max-width: 62.5rem; border-collapse: collapse; border-radius: .5rem; overflow: hidden; box-shadow: 0 .25rem 1.5rem hsl(210,15%,12%,0.10);">
                  ...
                  <td valign="middle">
                    <a href="<?php echo $site_url; ?>"
                      ...
                      <img src="<?php echo $logo_url; ?>"
                           ...
                           width="240"
                           height="auto"
                           style="background-color: transparent; display: block; width:auto; max-width: 15rem; height: auto; max-height:5.5rem; border: 0;">
                    </a>
                  </td>
                  <!-- Date/time -->
                  <td valign="middle"
                      align="right"
                      class="header-date"
                      style="color: hsl(210,20%,70%); font-family:<?php echo $ff; ?>; font-size: .8125rem; text-align: right; line-height: 1.5; white-space: nowrap;">
          ...
          <tr>
            <td class="accent-bar"
                role="presentation"
                style="background-color: <?php echo $c_red; ?>; font-size: 0; line-height: 0; height: 4px;">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td class="email-hero"
              ...
              <div class="hero-badge"
                   style="color:<?php echo $c_white; ?>; background-color:<?php echo $badge_color; ?>; font-family:<?php echo $ff; ?>; font-size: .875rem; font-weight: 700; letter-spacing: 0.10em; text-transform: uppercase; display: inline-block; padding: .25rem .75rem; margin-bottom: .875rem; border-radius: 6.25rem;">
                <?php echo $form_label; ?>
              </div>
              ...
              <h1 class="hero-title"
                  ...
                  style="color:<?php echo $c_white; ?>; font-family:<?php echo $ff; ?>; font-size: 2rem; font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 0;">
                <?php echo $hero_title; ?>
              </h1>

              <!-- Sub-heading -->
              <p class="hero-subtitle"
                 style="color: hsl(210,20%,72%); font-family:<?php echo $ff; ?>;font-size: .9375rem; line-height: 1.5; margin: .625rem 0 0;">
          ...
          <tr>
            <td class="email-body" style="background-color:<?php echo $c_white; ?>;">
              ...
              <div class="info-card"
                   ...
                   style="background-color:<?php echo $c_info_bg; ?>; padding: .875rem 1.125rem; margin: 1.75rem 2.5rem 0; border: 1px solid <?php echo $c_info_bd; ?>; border-radius: .5rem;">
                <table role="presentation"
                       border="0" cellpadding="0" cellspacing="0"
                       width="100%"
                       style="border-collapse: collapse;">
                  <tr>
                    ...
                    <td valign="top"
                      ...
                      <div class="info-icon"
                           aria-hidden="true"
                           style="color:<?php echo $c_white; ?>; background-color:<?php echo $c_blue; ?>; font-family:<?php echo $ff; ?>; font-size: .8125rem; font-weight: 800; text-align: center; line-height: 1.375rem; display: inline-block; width: 1.375rem; height: 1.375rem; border-radius: 50%;">
                        i
                      </div>
                    </td>
                    <!-- Text -->
                    <td valign="top">
                      <p class="info-text"
                         style="color:<?php echo $c_info_tx; ?>; font-family:<?php echo $ff; ?>;font-size: .875rem; line-height: 1.55; margin: 0;">
              ...
              <div class="section-label" style="padding:1.5rem 2.5rem .625rem;">
                <h2 class="section-label-text"
                    ...
                    style="color:<?php echo $c_muted; ?>; font-family:<?php echo $ff; ?>;font-size: .875rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0;">
                  Submission Details
                </h2>
              </div>
              ...
              <!-- Bottom spacer -->
              <div style="font-size:0; line-height:2.5rem; height:2.5rem;" aria-hidden="true">&nbsp;</div>
            ...
            <td class="email-footer"
              ...
              <a href="<?php echo $site_url; ?>"
                ...
                <img src="<?php echo $logo_url; ?>"
                     ...
                     width="100"
                     height="auto"
                     style="background-color: transparent; display:block; width:auto; max-width: 15rem; height: auto; max-height:5.5rem; margin-bottom:1rem; border: 0;">
              </a>

              <!-- Organization info -->
              <address style="font-style:normal;" aria-label="Organization contact information">
                <p class="footer-addr"
                   style="color:hsl(210,20%,60%); font-family:<?php echo $ff; ?>;font-size: .8125rem; line-height: 1.7; margin: 0 0 1rem;">
              ...
              <hr class="footer-divider"
                  role="separator"
                  style="background-color: hsl(223,40%,20%); height: 1px; margin: 0 0 1.125rem; border: none;">

              <!-- Automated-message note -->
              <p class="footer-note"
                 style="color:hsl(210,15%,45%); font-family:<?php echo $ff; ?>; font-size:.75rem; line-height:1.6; margin:0;">
